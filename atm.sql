...
CREATE OR REPLACE TRIGGER OPERATION_BIR
BEFORE INSERT ON OPERATION
FOR EACH ROW
BEGIN
    SELECT OPERATION_SEQ.NEXTVAL
    INTO   :new.id
    FROM   dual;
END;
...
INSERT INTO CARD(ID, CARD, PASSWORD, CREATED_AT, USER_ID) VALUES(1, '6666', '8ea15a38c4c1a177d509c85ef6623e23', TO_DATE('2003/05/03 21:02:44', 'yyyy/mm/dd hh24:mi:ss'), 1);